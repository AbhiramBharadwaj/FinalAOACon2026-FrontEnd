                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="p-3 bg-sky-50 rounded-xl border border-sky-200">
                      ...
                      <Link className='mt-5 block flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-sm bg-[#005aa9] text-white rounded-xl hover:bg-[#004684]  transition-all font-medium shadow-sm hover:shadow-md' to={`http://13.60.209.145:5050/${selectedAbstract.filePath}`}>Check Abstract</Link>
                    </div>
                  </div>
