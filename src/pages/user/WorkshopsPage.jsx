...
import { ChevronRight, Stethoscope, GraduationCap, Users2, BadgeInfo } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 pb-20">
        ...
        <section className="mt-6 rounded-2xl border border-amber-200 bg-amber-50 px-4 sm:px-5 py-5 shadow-sm">
          <p className="text-sm font-semibold text-slate-900 flex items-center gap-2">
            <BadgeInfo className="w-4 h-4 text-amber-700" />
            National Co-Ordinators for AOA Certificate Course
          </p>
          <p className="mt-2 text-sm text-slate-700">{CERTIFICATE_COURSE_COORDINATORS.join(' • ')}</p>
          <Link
            to="/workshops/aoa-certificate-course"
            className="mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#005aa9] text-white text-sm font-semibold hover:bg-[#004a8b] transition-colors"
          >
            View AOA Certificate Course
