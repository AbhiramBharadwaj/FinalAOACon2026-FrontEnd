                ...
                {existingAbstract.status === 'APPROVED' && (
                  <div className="text-center p-6 border-2 border-[#7cb342]/30 rounded-xl bg-[#7cb342]/10">
                    ...
                    <button
                      ...
                      className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#7cb342] px-4 py-2.5 text-xs font-semibold text-white transition hover:bg-[#68c239]"
                    >
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 space-y-4 pb-20">
        <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl px-4 py-3 flex items-center mb-4">
          ...
          <div className="ml-3">
            <h1 className="text-2xl font-semibold text-slate-900">Submit E-Poster Abstract</h1>
            <p className="text-base text-slate-600">Upload your abstract in MS Word format for AOACON 2026, Shivamogga</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
          <section className="lg:col-span-2 space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border border-slate-200/50 rounded-lg text-base text-slate-900 focus:ring-1 focus:ring-[#9c3253]/50 focus:border-[#9c3253]/50 bg-white/50 backdrop-blur-sm placeholder:text-slate-400 ${errors.title ? 'border-red-400/50' : ''}`}
                  />
                  {errors.title && <p className="text-sm text-red-500 mt-1">{errors.title}</p>}
                  <p className="text-sm text-slate-500 mt-2">Title should be entered in uppercase.</p>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    placeholder="Full author names with institutional affiliations. Clearly indicate the presenting author."
                    className={`w-full px-4 py-3 border border-slate-200/50 rounded-lg text-base text-slate-900 focus:ring-1 focus:ring-[#9c3253]/50 focus:border-[#9c3253]/50 bg-white/50 resize-vertical placeholder:text-slate-400 ${errors.authors ? 'border-red-400/50' : ''}`}
                  />
                  {errors.authors && <p className="text-sm text-red-500 mt-1">{errors.authors}</p>}
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border border-slate-200/50 rounded-lg text-base text-slate-900 focus:ring-1 focus:ring-[#9c3253]/50 bg-white/50 ${errors.category ? 'border-red-400/50' : ''}`}
                  >
            ...
            <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl p-4">
              ...
              >
                {abstractFile ? (
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <div className="flex items-center bg-[#ff8a1f]/10 text-[#ff8a1f] px-3 py-2 rounded border border-[#ff8a1f]/20 text-sm">
                  ...
                  <>
                    ...
                    <div>
                      <label htmlFor="abstract-file" className="inline-flex items-center px-4 py-2.5 border border-[#ff8a1f]/30 bg-[#ff8a1f]/10 text-[#ff8a1f] rounded-xl cursor-pointer hover:bg-[#ff8a1f]/20 transition-all font-medium text-sm">
              ...
              {errors.file && <p className="text-sm text-red-500 mt-2 text-center">{errors.file}</p>}
            </div>
          </section>
          ...
          <section className="lg:col-span-1 lg:sticky lg:top-4 space-y-4">
            ...
            <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl p-4">
              ...
              <div className="space-y-2 text-sm text-[#ff8a1f]">
                ...
                <div>• Presenting author must be registered for the conference</div>
              </div>
            </div>
          </section>
        </div>
