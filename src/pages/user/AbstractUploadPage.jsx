    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 space-y-4 pb-20">
        <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl px-4 py-3 flex items-center mb-4">
          ...
          <div className="ml-3">
            <h1 className="text-lg font-semibold text-slate-900">Submit E-Poster Abstract</h1>
            <p className="text-xs text-slate-600">Upload your abstract in MS Word format for AOACON 2026, Shivamogga</p>
          </div>
        </div>
            ...
            <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-xl p-4 space-y-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1">Title should be entered in uppercase.</p>
                </div>
              ...
              >
                {abstractFile ? (
                  ...
                  <>
                    ...
                    <p className="text-[10px] text-slate-500 mt-2">Max 10MB • .doc or .docx only</p>
                  </>
                )}
              </div>
