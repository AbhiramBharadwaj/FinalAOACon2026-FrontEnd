      ...
      <div className="mx-auto max-w-5xl px-4 lg:px-6 py-6 lg:py-10 pb-20">
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-slate-700">
              <li>Final e-poster file format: PDF, DOCX, PPT, or PPTX</li>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-slate-700">
              ...
              <li>
                The uploaded file in this portal is the abstract document. Accepted authors must later submit the final e-poster file separately.
              </li>
            </ul>
          </section>
