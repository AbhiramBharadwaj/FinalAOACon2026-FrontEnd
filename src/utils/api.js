...
export const adminAPI = {
  ...
  getManagedAccommodations: () => api.get('/admin/managed-accommodations'),
  createManagedAccommodation: (data) => api.post('/admin/managed-accommodations', data),
  updateManagedAccommodation: (id, data) => api.put(`/admin/managed-accommodations/${id}`, data),
  getManagedAccommodationSettings: () => api.get('/admin/accommodation-settings/harsha-fern'),
  updateManagedAccommodationSettings: (data) => api.put('/admin/accommodation-settings/harsha-fern', data),
